...
export const cfopMap: Record<number, string> = {
   ...
   1305: 'Aquisição de serviço de comunicação por estabelecimento de geradora ou de distribuidora de energia elétrica 1.306 - Aquisição de serviço de comunicação por estabelecimento de produtor rural',
   ...
   1603: 'Ressarcimento de ICMS retido por substituição tributária 1.604 - Lançamento do crédito relativo à compra de bem para o ativo imobilizado',
   ...
   2120: 'Compra para industrialização, em venda à ordem, já recebida do vendedor remetente 2.121 - Compra para comercialização, em venda à ordem, já recebida do vendedor remetente',
   ...
   2401: 'Compra para industrialização ou produção rural em operação com mercadoria sujeita ao regime desubstituição tributária',
   ...
   2410: 'Devolução de venda de produção do estabelecimento em operação com produto sujeito ao regime desubstituição tributária',
   ...
   5501: 'Remessa de produção do estabelecimento, com fim específico de exportação 5.502 - Remessa de mercadoria adquirida ou recebida de terceiros, com fim específico de exportação',
   ...
   6153: 'Transferência de energia elétrica 6.155 - Transferência de produção do estabelecimento, que não deva por ele transitar',
   ...
   6912: 'Remessa de mercadoria ou bem para demonstração 6.913 - Retorno de mercadoria ou bem recebido para demonstração',
